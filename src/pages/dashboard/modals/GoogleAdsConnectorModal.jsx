...
import { FiX, FiCheck, FiBarChart2, FiLogOut } from "react-icons/fi";
import { FcGoogle } from "react-icons/fc";
import { C, Modal, T } from "../../../components/utils";
import googleAdsLogo from "../../../assets/logos/google-ads.png";

export default function GoogleAdsConnectorModal({ onClose }) {
        ...
        >
          <div style={{ display: "flex", gap: 18, alignItems: "center" }}>
            ...
            <div>
              ...
              >
                Sync leads directly from your Google Ads campaigns.
              </p>
            </div>
          </div>
          <button
          ...
          {!isConnected ? (
            <>
              ...
              <p style={{ margin: "0 0 30px", color: C.muted, fontSize: T.font.size.bodySmall, maxWidth: 400, lineHeight: 1.6 }}>
                Allow the CRM to access your Google Ads data to automatically sync new leads, track campaign performance, and measure ROI directly in the dashboard.
              </p>
            ...
            <>
              ...
              <p style={{ margin: "0 0 30px", color: C.muted, fontSize: T.font.size.bodySmall, maxWidth: 400, lineHeight: 1.6 }}>
                Your Google Ads account is now connected. Incoming leads from your campaigns will automatically sync with your CRM.
              </p>
...
GoogleAdsConnectorModal.propTypes = {
