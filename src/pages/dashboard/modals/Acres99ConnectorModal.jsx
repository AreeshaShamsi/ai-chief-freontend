            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", minWidth: 0 }}>
              ...
              <div
                style={{
                  ...
                  border: isCurrent || isDone ? `2px solid ${C.accent}` : `2px solid ${C.border}`,
                  display: "flex",
                  alignItems: "center",
...
const SETUP_STEPS = [
  {
    n: 1,
    title: "Go to your 99acres Account",
    desc: "Login to your 99acres Partner / Agent account.",
  },
  {
    n: 2,
    title: "Request CRM Integration",
    desc: "Contact your 99acres Account Manager and request CRM / API integration.",
  },
  {
    n: 3,
    title: "Provide Webhook URL",
    desc: "Share the webhook URL below with your 99acres Account Manager.",
  },
  {
    n: 4,
...
const WEBHOOK_URL = "https://crm.aichief.in/api/webhooks/99acres";

// ─── Main Modal ───────────────────────────────────────────────────────────────
export default function Acres99ConnectorModal({ onClose }) {
      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", gap: 18, alignItems: "flex-start", flex: 1, minWidth: 0 }}>
            <img
              src={acres99Logo}
              alt="99acres logo"
              style={{ width: 64, objectFit: "contain", flexShrink: 0 }}
            />
            <div>
              <h2
                style={{
              ...
              >
                Integrate with 99acres
              </h2>
              <p style={{ margin: "0 0 10px", color: C.muted, fontSize: T.font.size.bodySmall, lineHeight: 1.5 }}>
                Connect your 99acres account to automatically capture new leads
                <br />into your CRM in real-time.
              </p>
              <button
                type="button"
                style={{
        ...
        >
          ...
          >
            ...
            >
              1. Connect Your 99acres Account
            </h3>
            <p
              style={{
                margin: "0 0 20px",
            ...
            >
              Follow the steps below to connect 99acres with your CRM.
            </p>
                  ...
                  >
                    ...
                    <button
                      ...
                      style={{
                        ...
                        border: "none",
                        cursor: "pointer",
                        color: copied ? (C.green || "#10b981") : C.muted,
                        padding: 4,
                        flexShrink: 0,
                        display: "flex",
                        alignItems: "center",
          ...
          {/* ── RIGHT: About + JSON + Note ──────────────────────── */}
          <div style={{ padding: "24px 28px", display: "flex", flexDirection: "column", gap: 20 }}>

            {/* About 99acres Integration */}
            <div>
              <h3
                style={{
                  margin: "0 0 14px",
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 18 }}>
                {[
                  "Capture new leads in real-time",
                  "All leads will be added to your CRM automatically",
                  "No manual import required",
                  "Reduce response time and close more deals",
                ].map((benefit) => (
                  <div key={benefit} style={{ display: "flex", alignItems: "center", gap: 9 }}>
                    <span
                      style={{
                        width: 18,
                        height: 18,
                    ...
                    <span style={{ fontSize: T.font.size.bodySmall, color: C.text }}>
                      {benefit}
                    </span>
                  </div>
                ))}
              ...
              >
                ...
                >
                  <img src={acres99Logo} alt="99acres" style={{ width: 48, objectFit: "contain" }} />
                </div>
                ...
                >
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: "none",
                      cursor: "pointer",
                      color: jsonCopied ? "#34d399" : "rgba(255,255,255,0.5)",
                      display: "flex",
                      alignItems: "center",
                      gap: 4,
                      fontSize: T.font.size.caption,
                ...
                >
                  ...
                  {[
                    ...
                    <span key={key}>
                      ...
                      {i < arr.length - 1 ? <span style={{ color: "#94a3b8" }}>,</span> : null}
                      {"\n"}
                    </span>
                  ))}
                  <span style={{ color: "#94a3b8" }}>{"}"}</span>
            ...
            <div
              style={{
                border: `1px solid ${C.accentTrack || "#bfdbfe"}`,
                borderRadius: T.radius.md,
                background: C.accentLt,
                padding: "12px 14px",
                display: "flex",
            ...
            >
              <div style={{ display: "flex", gap: 8, alignItems: "flex-start", flex: 1 }}>
                ...
                <div>
                  ...
                  >
                    After connection, please test the integration to make sure leads are
                    coming into your CRM correctly.
                  </p>
                </div>
              </div>
              <button
...
Acres99ConnectorModal.propTypes = {
