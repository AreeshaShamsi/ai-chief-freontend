...
export default function SingleLineTextModal({
  open,
  onClose,
  onCreate,
  initialData = {},
  ...
  const handleSubmit = (e) => {
    ...
    if (onCreate) {
      onCreate({
        name: fieldName || "Single Line Text",
    ...
    >
      ...
      >
        <Text variant="cardTitle" style={{ marginBottom: T.spacing[4] }}>
          {isEdit ? "Edit Field Configuration" : "Configure Single Line Text Field"}
        </Text>
