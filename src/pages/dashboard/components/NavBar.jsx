...
const NAV = [{ id: "dashboard", e: "◼", l: "Dashboard" }, { id: "campaigns", e: "📢", l: "Campaigns", b: 3 }, { id: "leads", e: "👥", l: "Leads", b: 7 }, { id: "calls", e: "📞", l: "Call Log" }];
function Sidebar({ tab, setTab }) {
    return (
        <div style={{ width: 210, background: C.sidebar, display: "flex", flexDirection: "column", flexShrink: 0, borderRight: "1px solid #1A2540" }}>
            ...
            <div style={{ padding: "12px 18px", borderTop: "1px solid #1A2540", display: "flex", alignItems: "center", gap: 9 }}>
