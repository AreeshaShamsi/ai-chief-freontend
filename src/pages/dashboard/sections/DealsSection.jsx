...
export const dealColumns = [
  ...
  { id: "callCount",        name: "Total Calls",               type: "Number",                 value: "0",               _isCallCount: true },
  { id: "lastCalled",       name: "Last Called",               type: "Single Line Text",       value: "—",               _isLastCalled: true },
...
Objections noted: Spouse needs to be present for final decision. No loan pre-approval yet — HDFC Bank meeting scheduled next week.`,
      ...
      callHistory: [
        { date: "Dec 21, 2026 — 10:02 AM", score: "hot",  callOutcome: "Site Visit Scheduled",           aiSummary: "Budget ₹1.1–1.3 Cr confirmed. Site visit Saturday 11AM arranged. Sarjapur preferred.",         nextAction: "Confirm site visit — Saturday 11AM" },
        { date: "Dec 15, 2026 — 3:45 PM",  score: "warm", callOutcome: "Interested / Follow-up Required", aiSummary: "First contact. Prospect saw digital ad. Basic interest expressed but no specifics shared.", nextAction: "Call back in a week with project brochure" },
      ],
    },
...
Action agreed: Share a detailed comparison sheet by EOD showing price per sq ft, expected rental yield, and appreciation trends for both projects.`,
      ...
      callHistory: [
        { date: "Dec 22, 2026 — 2:15 PM",  score: "warm", callOutcome: "Interested / Follow-up Required", aiSummary: "First-time investor. HDFC pre-approved. Comparing Sobha with Prestige Lakeside.", nextAction: "Send comparison sheet by EOD" },
        { date: "Dec 10, 2026 — 11:30 AM", score: "cold", callOutcome: "No Answer",                        aiSummary: "Called but no answer. Left voicemail.",                                     nextAction: "Follow up in 3 days" },
      ],
    },
    createdTime: "14/08/2026 5:00pm",
    lastModifiedTime: "14/08/2026 5:00pm",
...
Action agreed: Send the full digital brochure and floor plan for Brigade Lakefront 2BHK units. Follow up call scheduled for Dec 24 at 12 PM to discuss and answer any questions.`,
      ...
      callHistory: [
        { date: "Dec 21, 2026 — 4:30 PM", score: "warm", callOutcome: "Qualified Lead",  aiSummary: "IT professional. HDFC approved. Close to ITPL is key requirement. Interested in 2BHK.", nextAction: "Share brochure, follow-up call Dec 24" },
        { date: "Dec 14, 2026 — 9:45 AM", score: "warm", callOutcome: "Initial Contact", aiSummary: "First contact from a web form. Basic budget and location captured. Showed moderate interest.", nextAction: "Follow up in a week" },
        { date: "Dec 8, 2026 — 2:00 PM",  score: "cold", callOutcome: "No Answer",       aiSummary: "No response. Left SMS follow-up.",                                                          nextAction: "Retry after 3 days" },
      ],
    },
    createdTime: "14/08/2026 5:00pm",
    lastModifiedTime: "14/08/2026 5:00pm",
