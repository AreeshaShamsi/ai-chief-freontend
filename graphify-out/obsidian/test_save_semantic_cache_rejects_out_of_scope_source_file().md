...
# test_save_semantic_cache_rejects_out_of_scope_source_file()

## Connections
- [[1757 an undispatched file must keep its complete cache entry when a semantic…]] - `rationale_for` [EXTRACTED]
