...
## Members
- [[Non-dict inputs are guarded and return empty nodesedges.]] - rationale - temp-graphify/tests/test_scip_ingest.py
- [[parametrize_23]] - code
- [[test_ingest_non_dict_input_returns_empty()]] - code - temp-graphify/tests/test_scip_ingest.py
