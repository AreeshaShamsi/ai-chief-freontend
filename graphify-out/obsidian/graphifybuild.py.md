...
- [[_coerce_id()]] - `contains` [EXTRACTED]
- [[_coerce_non_string_ids()]] - `contains` [EXTRACTED]
...
- [[_is_ast_tier()]] - `contains` [EXTRACTED]
...
- [[test_non_string_node_ids.py]] - `imports_from` [EXTRACTED]
