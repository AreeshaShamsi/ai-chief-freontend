...
- [[_graph_ids()]] - `contains` [EXTRACTED]
- [[_portability_corpus()]] - `contains` [EXTRACTED]
- [[_reset_stat_index()]] - `contains` [EXTRACTED]
...
- [[test_cached_ids_round_trip_under_the_same_root()]] - `contains` [EXTRACTED]
...
- [[test_relative_root_does_not_reanchor_an_already_canonical_id()]] - `contains` [EXTRACTED]
...
- [[test_warm_cache_from_another_root_does_not_leak_that_root()]] - `contains` [EXTRACTED]
