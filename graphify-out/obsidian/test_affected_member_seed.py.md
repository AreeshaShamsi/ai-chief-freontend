---
source_file: "temp-graphify/tests/test_affected_member_seed.py"
type: "code"
...
## Connections
- [[1669 — affected Class must reach callers that bind to the class's method…]] - `rationale_for` [EXTRACTED]
