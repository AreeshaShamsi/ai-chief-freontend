...
# test_semantic_cache_normalizes_absolute_source_file()

## Connections
- [[2197 an item whose source_file is absolute is persisted root-relative posix,…]] - `rationale_for` [EXTRACTED]
