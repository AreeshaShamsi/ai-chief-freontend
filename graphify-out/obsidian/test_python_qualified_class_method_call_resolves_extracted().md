...
# test_python_qualified_class_method_call_resolves_extracted()

## Connections
- [[`ClassName.method()` across files resolves to the class-qualified method node…]] - `rationale_for` [EXTRACTED]
