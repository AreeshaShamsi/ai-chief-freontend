...
# test_to_html_unannotated_identical_to_pre_feature()

## Connections
- [[With no overlay, the HTML is byte-identical whether learning_overlay is omitted…]] - `rationale_for` [EXTRACTED]
