...
# test_ts_injected_field_resolves_to_typed_class_not_same_named_collision()

## Connections
- [[The decisive 1316 guardrail two classes each define `query`, but the injected…]] - `rationale_for` [EXTRACTED]
