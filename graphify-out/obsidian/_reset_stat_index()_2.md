...
## Connections
- [[The stat-index locationanchor are chosen once per process via module globals…_1]] - `rationale_for` [EXTRACTED]
...
- [[test_relative_key_wins_over_colliding_legacy_absolute()]] - `calls` [EXTRACTED]
