...
# End to end: packing a corpus that includes a special-token doc must not raise…

## Connections
- [[test_pack_chunks_with_special_token_doc_does_not_crash()]] - `rationale_for` [EXTRACTED]
