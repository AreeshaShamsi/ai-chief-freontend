...
## Connections
- [[dot-__init__()_18]] - `calls` [EXTRACTED]
- [[dot-__init__()_28]] - `method` [EXTRACTED]
- [[dot-aclose()_2]] - `method` [EXTRACTED]
- [[dot-handle_async_request()_1]] - `method` [EXTRACTED]
- [[AsyncBaseTransport]] - `inherits` [EXTRACTED]
- [[AsyncClient]] - `uses` [INFERRED]
- [[BaseClient_1]] - `uses` [INFERRED]
