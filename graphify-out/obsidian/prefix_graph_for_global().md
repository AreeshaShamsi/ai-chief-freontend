...
## Connections
- [[Return a copy of G with all node IDs prefixed with repo_tag. Labels are…]] - `rationale_for` [EXTRACTED]
...
- [[test_prefix_graph_rewrites_edge_directional_attributes()]] - `calls` [EXTRACTED]
