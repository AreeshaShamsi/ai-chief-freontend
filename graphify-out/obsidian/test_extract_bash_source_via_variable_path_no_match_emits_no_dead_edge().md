...
# test_extract_bash_source_via_variable_path_no_match_emits_no_dead_edge()

## Connections
- [[A variable-built source path with no matching file on disk must emit no import…]] - `rationale_for` [EXTRACTED]
