...
## Members
- [[A single symbol with no relationships yields one node and zero edges.]] - rationale - temp-graphify/tests/test_scip_ingest.py
- [[test_ingest_single_symbol_no_relationships()]] - code - temp-graphify/tests/test_scip_ingest.py
