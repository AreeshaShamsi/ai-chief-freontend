...
# #1402 (Go): the sourceless-stub fix landed in six extractors but the Go copy of…

## Connections
- [[test_go_cross_file_type_refs_resolve_to_single_node()]] - `rationale_for` [EXTRACTED]
