...
## Members
- [[Symbol ending with '' and no display_name must produce a non-empty label.…]] - rationale - temp-graphify/tests/test_scip_ingest.py
- [[test_ingest_symbol_trailing_hash_no_display_name_has_non_empty_label()]] - code - temp-graphify/tests/test_scip_ingest.py
