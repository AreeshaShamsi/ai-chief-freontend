...
# test_resolve_cross_file_raw_calls_survives_malformed_raw_calls()

## Connections
- [[The python cross-file resolver returns  (not crash) on bad raw_calls.]] - `rationale_for` [EXTRACTED]
