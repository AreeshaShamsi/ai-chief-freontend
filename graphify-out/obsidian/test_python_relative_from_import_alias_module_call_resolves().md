...
# test_python_relative_from_import_alias_module_call_resolves()

## Connections
- [[`from . import mod as alias` -- a relative sibling-module import with an alias…]] - `rationale_for` [EXTRACTED]
