...
# test_agents_uninstall_preserves_user_h3_graphify_heading()

## Connections
- [[2062 end-to-end uninstall strips graphify's own H2 section but leaves a user-…]] - `rationale_for` [EXTRACTED]
