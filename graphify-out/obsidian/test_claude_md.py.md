---
source_file: "temp-graphify/tests/test_claude_md.py"
type: "code"
...
- [[test_uninstall_cleans_both_standard_and_local()]] - `contains` [EXTRACTED]
...
- [[test_uninstall_preserves_other_content_in_local_md()]] - `contains` [EXTRACTED]
- [[test_uninstall_removes_hook_from_settings_local_json()]] - `contains` [EXTRACTED]
- [[test_uninstall_removes_section()]] - `contains` [EXTRACTED]
- [[test_uninstall_removes_section_from_dot_claude_local_md()]] - `contains` [EXTRACTED]
- [[test_uninstall_removes_section_from_root_claude_local_md()]] - `contains` [EXTRACTED]
- [[test_uninstall_removes_settings_hook()]] - `contains` [EXTRACTED]
- [[test_uninstall_tolerates_unreadable_local_md()]] - `contains` [EXTRACTED]
