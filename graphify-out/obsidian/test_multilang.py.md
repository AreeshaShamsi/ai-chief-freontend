...
- [[_edge_labels()_1]] - `contains` [EXTRACTED]
- [[_edges_with_relation()_1]] - `contains` [EXTRACTED]
- [[_extract_sql_or_skip()]] - `contains` [EXTRACTED]
- [[_labels()_5]] - `contains` [EXTRACTED]
- [[_normalize_symbol_label()_1]] - `contains` [EXTRACTED]
...
- [[test_go_embeds_struct_field()]] - `contains` [EXTRACTED]
...
- [[test_go_interface_embedding_emits_embeds()]] - `contains` [EXTRACTED]
- [[test_go_method_declaration_emits_refs_only_when_name_present()]] - `contains` [EXTRACTED]
- [[test_go_method_parameter_return_contexts()]] - `contains` [EXTRACTED]
- [[test_go_no_dangling_edges()]] - `contains` [EXTRACTED]
- [[test_go_struct_named_field_emits_field_context()]] - `contains` [EXTRACTED]
...
- [[test_rust_enum_variant_references()]] - `contains` [EXTRACTED]
...
- [[test_rust_method_parameter_return_and_generic_contexts()]] - `contains` [EXTRACTED]
- [[test_rust_no_cross_crate_spurious_edges()]] - `contains` [EXTRACTED]
- [[test_rust_no_dangling_edges()]] - `contains` [EXTRACTED]
- [[test_rust_struct_field_emits_field_context()]] - `contains` [EXTRACTED]
- [[test_rust_supertrait_emits_inherits()]] - `contains` [EXTRACTED]
- [[test_rust_trait_impl_emits_implements()]] - `contains` [EXTRACTED]
- [[test_rust_tuple_struct_field_references()]] - `contains` [EXTRACTED]
- [[test_sql_alter_table_fk_edge()]] - `contains` [EXTRACTED]
- [[test_sql_cross_file_fk_resolves_and_never_leaks_scan_path()]] - `contains` [EXTRACTED]
...
- [[test_sql_plpgsql_clean_function_not_double_emitted()]] - `contains` [EXTRACTED]
- [[test_sql_plpgsql_functions_survive_parse_errors()]] - `contains` [EXTRACTED]
- [[test_sql_quoted_plpgsql_file_stays_clean()]] - `contains` [EXTRACTED]
- [[test_sql_quoted_plpgsql_routines_are_recovered()]] - `contains` [EXTRACTED]
- [[test_sql_schema_qualified_alter_fk()]] - `contains` [EXTRACTED]
- [[test_sql_schema_qualified_names()]] - `contains` [EXTRACTED]
