...
# test_checkpoint_writes_deep_namespace_in_deep_mode()

## Connections
- [[1894 the per-chunk checkpoint must follow the run's mode — a deep_mode=True…]] - `rationale_for` [EXTRACTED]
- [[dot-ok()]] - `indirect_call` [INFERRED]
