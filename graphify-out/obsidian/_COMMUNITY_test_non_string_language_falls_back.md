...
## Members
- [[`language` as a non-string falls back to the function default.]] - rationale - temp-graphify/tests/test_scip_ingest.py
- [[test_non_string_language_falls_back()]] - code - temp-graphify/tests/test_scip_ingest.py
