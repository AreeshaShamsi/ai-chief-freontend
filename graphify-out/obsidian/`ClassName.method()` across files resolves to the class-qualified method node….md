...
# `ClassName.method()` across files resolves to the class-qualified method node…

## Connections
- [[test_python_qualified_class_method_call_resolves_extracted()]] - `rationale_for` [EXTRACTED]
