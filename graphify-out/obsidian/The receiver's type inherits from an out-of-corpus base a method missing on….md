...
# The receiver's type inherits from an out-of-corpus base: a method missing on…

## Connections
- [[test_unresolved_base_poisons_inherited_member_lookup()]] - `rationale_for` [EXTRACTED]
