...
## Members
- [[`relative_path` as a non-string falls back to the function's source_file…]] - rationale - temp-graphify/tests/test_scip_ingest.py
- [[test_non_string_relative_path_falls_back_to_default()]] - code - temp-graphify/tests/test_scip_ingest.py
