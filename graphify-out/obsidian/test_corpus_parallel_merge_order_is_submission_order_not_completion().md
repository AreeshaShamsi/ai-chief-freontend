...
# test_corpus_parallel_merge_order_is_submission_order_not_completion()

## Connections
- [[1632 merged nodeedge order must be deterministic (submission order), not the…]] - `rationale_for` [EXTRACTED]
