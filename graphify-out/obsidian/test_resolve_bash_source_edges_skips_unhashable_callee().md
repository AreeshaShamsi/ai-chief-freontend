...
# test_resolve_bash_source_edges_skips_unhashable_callee()

## Connections
- [[A bash raw_call with `callee list` (unhashable for dict membership) must not…]] - `rationale_for` [EXTRACTED]
