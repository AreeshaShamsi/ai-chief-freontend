...
## Connections
- [[IMPORTANT resolve endpoints using source_file only; never infer from…]] - `rationale_for` [EXTRACTED]
- [[Graph analysis god nodes (most connected), surprising connections (cross-…]] - `rationale_for` [EXTRACTED]
