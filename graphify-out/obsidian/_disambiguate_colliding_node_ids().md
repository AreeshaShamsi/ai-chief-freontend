...
- [[Rewrite only colliding node IDs, using source path as the disambiguator. Module…]] - `rationale_for` [EXTRACTED]
- [[_make_id()]] - `calls` [EXTRACTED]
- [[_node_disambiguation_source_key()]] - `calls` [EXTRACTED]
- [[_source_key()]] - `calls` [EXTRACTED]
