...
# test_out_of_scope_nodes_are_dropped_from_merged_result()

## Connections
- [[1895 the 1757 cache guard skips the CACHE write for a node attributed to a…]] - `rationale_for` [EXTRACTED]
