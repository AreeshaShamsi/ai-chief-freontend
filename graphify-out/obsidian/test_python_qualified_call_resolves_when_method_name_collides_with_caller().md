...
# test_python_qualified_call_resolves_when_method_name_collides_with_caller()

## Connections
- [[The real 1446 shape a viewset action `approve()` delegates to a SERVICE…]] - `rationale_for` [EXTRACTED]
