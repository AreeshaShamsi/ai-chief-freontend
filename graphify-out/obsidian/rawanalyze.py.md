...
## Connections
- [[Graph analysis god nodes (most connected), surprising connections (cross-…_1]] - `rationale_for` [EXTRACTED]
...
- [[_node_community_map()_2]] - `contains` [EXTRACTED]
- [[_surprise_score()_1]] - `contains` [EXTRACTED]
- [[_top_level_dir()_1]] - `contains` [EXTRACTED]
- [[cohesion_score()_1]] - `imports` [EXTRACTED]
