...
# test_extract_bash_bare_source_missing_file_fabricates_nothing()

## Connections
- [[The 2171 bare-name branch keeps the existence gate a name that resolves to no…]] - `rationale_for` [EXTRACTED]
