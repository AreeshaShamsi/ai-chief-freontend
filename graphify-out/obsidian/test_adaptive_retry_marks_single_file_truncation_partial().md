...
# test_adaptive_retry_marks_single_file_truncation_partial()

## Connections
- [[A non-splittable single-file truncation keeps its partial result but marks…]] - `rationale_for` [EXTRACTED]
