...
# test_resolve_bash_source_edges_accepts_none_per_file_entries()

## Connections
- [[A None entry in per_file (e.g. failed extraction) must be silently skipped.]] - `rationale_for` [EXTRACTED]
