...
# test_to_html_neighbor_links_have_no_inline_onclick_xss()

## Connections
- [[1838 neighbor links dropped an unescaped JSON.stringify(nid) into a quoted…]] - `rationale_for` [EXTRACTED]
