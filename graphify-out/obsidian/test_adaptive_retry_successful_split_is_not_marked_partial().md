...
# test_adaptive_retry_successful_split_is_not_marked_partial()

## Connections
- [[A truncation that IS recovered by splitting yields a complete result — it must…]] - `rationale_for` [EXTRACTED]
